...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" AYO SEMANGAT AWALI DENGAN BASMALAH BIAR BERKAH :)")
    time.sleep(1)
    os.system("xdg-open https://www.facebook.com/profile.php?id=100081875584676")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : EDWIN FAJARR ")
    print ("    > FACEBOOK : FAJAR ")
